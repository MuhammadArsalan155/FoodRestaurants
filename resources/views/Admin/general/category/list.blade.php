        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="rounded bg-secondary-subtle d-flex align-items-center justify-content-center mx-auto">
                    <img src="/assets/admin//assets/admin/images/product/p-1.png" alt="" class="avatar-xl">
                </div>
        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="rounded bg-primary-subtle d-flex align-items-center justify-content-center mx-auto">
                    <img src="/assets/admin//assets/admin/images/product/p-6.png" alt="" class="avatar-xl">
                </div>
        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="rounded bg-warning-subtle d-flex align-items-center justify-content-center mx-auto">
                    <img src="/assets/admin//assets/admin/images/product/p-7.png" alt="" class="avatar-xl">
                </div>
        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="rounded bg-info-subtle d-flex align-items-center justify-content-center mx-auto">
                    <img src="/assets/admin//assets/admin/images/product/p-9.png" alt="" class="avatar-xl">
                </div>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-1.png" alt="" class="avatar-md">
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-2.png" alt="" class="avatar-md">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-4.png" alt="" class="avatar-md">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-6.png" alt="" class="avatar-md">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-7.png" alt="" class="avatar-md">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-8.png" alt="" class="avatar-md">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin//assets/admin/images/product/p-11.png" alt="" class="avatar-md">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                            <img src="/assets/admin/images/product/p-9.png" alt="" class="avatar-md">
                                        </div>
                                        <div>

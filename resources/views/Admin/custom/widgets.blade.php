                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="avatar-group">
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/assets/admin/images/users/avatar-2.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/assets/admin/images/users/avatar-3.jpg" alt="avatar-3" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/assets/admin/assets/admin/images/users/avatar-4.jpg" alt="avatar-4" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                    </td>
                                    <td>12 April 2024</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar-group">
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/assets/admin/images/users/avatar-1.jpg" alt="avatar-1" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/assets/admin/images/users/avatar-5.jpg" alt="avatar-5" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                    </td>
                                    <td>10 April 2024</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar-group">
                                        ...
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/images/users/avatar-3.jpg" alt="avatar-3" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                    </td>
                                    <td>31 March 2024</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar-group">
                                        ...
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/images/users/avatar-7.jpg" alt="avatar-7" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/images/users/avatar-6.jpg" alt="avatar-6" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                    </td>
                                    <td>25 March 2024</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar-group">
                                        ...
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/images/users/avatar-4.jpg" alt="avatar-4" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                        <a href="javascript:void(0);" class="avatar-group-item">
                                            <img src="/assets/admin/assets/admin/images/users/avatar-2.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle avatar-border" />
                                        </a>
                                    </td>
                                    <td>15 March 2024</td>
                                    <td>
                ...
                <div class="p-3" data-simplebar style="max-height: 400px;">
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-10.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-5" />
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-9.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-6" />
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-8.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-7" />
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-7.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-8" />
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-6.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-9" />
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-5.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-5" />
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="mb-1 fs-14"><a href="#!">Victoria P. Miller</a></h5>
                            <p class="mb-0">no mutual friends</p>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-4.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-6" />
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="mb-1 fs-14"><a href="#!">Dallas C. Payne</a></h5>
                            <p class="mb-0">856 mutual friends</p>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-3.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-7" />
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="mb-1 fs-14"><a href="#!">Florence A. Lopez</a></h5>
                            <p class="mb-0">52 mutual friends</p>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-2.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-8" />
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="mb-1 fs-14"><a href="#!">Gail A. Nix</a></h5>
                            <p class="mb-0">12 mutual friends</p>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="/assets/admin/assets/admin/images/users/avatar-1.jpg" class="img-fluid avatar-sm rounded me-2" alt="avatar-9" />
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="mb-1 fs-14"><a href="#!">Lynne J. Petty</a></h5>
                            <p class="mb-0">no mutual friends</p>
